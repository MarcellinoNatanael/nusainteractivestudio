...
(function () {
  ...
  var T = {
    en: {
      ...
      'proj-demit-genre':'Psychological Horror',
      'proj-demit-desc': 'Survival horror rooted in Javanese mythology, where every shadow hides something waiting to strike.',
      'proj-pg-genre':   'Folklore Horror',
      'proj-pg-desc':    'A psychological horror steeped in Indonesian folklore and the price of a forbidden bargain.',
      'proj-gombel-genre':'Survival Horror',
      'proj-gombel-desc':'A first-person survival horror built around the legend of Wewe Gombel. In development.',
      'sec-news':        'News',
      'sec-gallery':     'Gallery',
      'sec-careers':     'Careers',
    ...
    id: {
      ...
      'proj-demit-genre':'Horor Psikologis',
      'proj-demit-desc': 'Horor bertahan hidup berakar pada mitologi Jawa, di mana setiap bayangan menyimpan sesuatu yang mengintai.',
      'proj-pg-genre':   'Horor Cerita Rakyat',
      'proj-pg-desc':    'Horor psikologis yang kental dengan cerita rakyat Indonesia dan harga dari sebuah perjanjian terlarang.',
      'proj-gombel-genre':'Horor Bertahan Hidup',
      'proj-gombel-desc':'Horor bertahan hidup sudut pandang orang pertama yang dibangun dari legenda Wewe Gombel. Masih dalam pengembangan.',
      'sec-news':        'Berita',
      'sec-gallery':     'Galeri',
      'sec-careers':     'Karir',
